...
from unetr_pp.training.network_training.network_trainer_general_purpose import NetworkTrainerGeneralPurpose
...
class TrainerGeneralPurpose(NetworkTrainerGeneralPurpose):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(TrainerGeneralPurpose, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(TrainerGeneralPurpose, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(TrainerGeneralPurpose, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
