...
from unetr_pp.network_architecture.general_purpose.unetr_pp_general_purpose import UNETR_PP
...
class unetr_pp_trainer_general_purpose(TrainerGeneralPurpose):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        # Persist crop sizes in checkpoint metadata so inference can rebuild the exact same network shape.
        self.init_args = (
            plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
            deterministic, fp16, crop_size_x, crop_size_y, crop_size_z
        )
